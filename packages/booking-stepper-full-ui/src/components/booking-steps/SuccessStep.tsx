...
export const SuccessStep: React.FC<SuccessStepProps> = ({ bookingData }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto text-center space-y-6">
      ...
      >
        <h2 className="text-2xl font-semibold mb-2 text-white">Booking Confirmed!</h2>
      ...
      >
        <Card className="p-6 text-left">
          <h3 className="text-lg font-medium mb-4 text-center text-white">Appointment Details</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">{formatDateTime(bookingData.start)}</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">{attendee.name}</p>
                <p className="text-gray-400">{responses['customer-phone']}</p>
              </div>
            </div>
